...
import com.example.DangerBook.data.local.user.UserDao         // Import del DAO de usuario
import com.example.DangerBook.data.local.user.UserEntity      // Import de la entidad de usuario
